                  ...
                  <div class="setting-form">
                    <form id="contacts_s_form" method="post" action="?"> 
                      <div class="setting-contacts-form">
                        <div class="setting-form-left-side">
                          ...
                          <div class="setting-form-site-title">
                            ...
                            <input type="text" name="pn1" id="pn1_inp" placeholder="Phone number-1" style="margin-bottom: 1rem;" required>
                            <input type="text" name="pn2" id="pn2_inp" placeholder="Phone number-2" required>
                          </div> 
                          <div class="setting-form-site-title">
                            <label>Email</label>
                        ...
                        <div class="setting-form-right-side">
                          <div class="setting-form-site-title">
                            ...
                            <input type="text" name="fb" id="fb_inp" placeholder="Facebook" style="margin-bottom: 1rem;" required>
                            <input type="text" name="insta" id="insta_inp" placeholder="Instagram" style="margin-bottom: 1rem;" required>
                            <input type="text" name="linkedin" id="linkedin_inp" placeholder="Linkedin" required>
                          </div> 
                          <div class="setting-form-site-title">
                      ...
                      <div class="setting-button">
                        <button type="cancel" onclick="closePopup()" onclick="contacts_inp(contacts_data)">Cancel</button>
